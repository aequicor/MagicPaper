...
class PaperChatScrollState(private val listState: LazyListState) {
    ...
    fun preserveCollapsedItem(itemKey: Any, index: Int) {
        ...
        // paperChatDisclosure already captured the exact header coordinates, including
...
@Composable
fun PaperChatScrollItem(scroll: PaperChatScrollState, key: Any, content: @Composable () -> Unit) {
...
fun Modifier.paperChatDisclosure(
 ...
 */
@Composable
fun paperStickToBottom(listState: LazyListState, resetKey: Any? = Unit): PaperChatScrollState {
    val scroll = remember(listState, resetKey) { PaperChatScrollState(listState) }
