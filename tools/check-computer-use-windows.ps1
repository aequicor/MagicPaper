...
Push-Location $repo
try {
    & .\gradlew.bat :feature:session:impl:jvmTest --tests '*WindowCaptureExclusionTest' --tests '*DesktopComputerWindowsIntegrationTest' --tests '*DesktopComputerUseTest' --tests '*ScreenshotEncodingTest' --tests '*DesktopScreenshotDetailTest' '-Pmagicpaper.computer.windows.native=true' --rerun
