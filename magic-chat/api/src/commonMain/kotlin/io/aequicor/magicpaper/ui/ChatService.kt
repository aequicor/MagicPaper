...
interface ChatService {
    ...
    val questionnaires: StateFlow<List<UserInteractionRequest>>
    val questionnaireDrafts: StateFlow<Map<String, QuestionnaireDraft>>
    ...
    fun pause()
    /** Leaves the stopped request without replaying it; history and external receipts remain intact. */
    fun discardPendingRequest()
