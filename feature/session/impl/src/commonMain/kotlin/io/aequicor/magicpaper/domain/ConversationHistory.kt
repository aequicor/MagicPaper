...
internal class HistoryActionRejected(message: String) : IllegalStateException(message)
...
internal fun <T> List<T>.through(messageId: String?, id: (T) -> String): List<T> {
...
internal fun CodingSession.fork(id: String = Id.new()): CodingSession = CodingSession(
