...
fun skillExperienceObserver(
    journal: () -> LocalSkillExperience?,
    verifier: SkillRunVerifier = SkillRunVerifier { SkillRunVerification() },
): io.aequicor.magicpaper.domain.CodingRunObserver = io.aequicor.magicpaper.domain.CodingRunObserver { runId, events, cancelled ->
    events.withSkillExperience(runId, journal, verifier, cancelled)
}
