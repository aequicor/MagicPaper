...
class DefaultSkillInstructionRuntime(private val source: SkillInstructionSource, private val gateway: LlmGateway) : SkillInstructionRuntime {
    override suspend fun answer(query: String, history: List<ChatMessage>, profile: LlmProfile?, attachments: List<Attachment>): String? {
...
fun SkillInstructionRuntime(source: SkillInstructionSource, gateway: LlmGateway): SkillInstructionRuntime = DefaultSkillInstructionRuntime(source, gateway)
