        ...
        try {
            LocalSkillRepository(base.resolve("repo"), SkillPackageHost("1.0.0", "desktop")).use { repo ->
                LocalSkillExperience(base.resolve("experience"), repo, gateway, { emptyList() }).use { j ->
                    ...
                    val plugin = LocalExperiencePlugin(j, profiles, io.aequicor.magicpaper.data.storage.desktopPersistenceStores(base.resolve("drafts").toFile()).drafts, backgroundScope)
