...
enum class AgentLimitField(val label: String, val minimum: Long = 1, val maximum: Long = Int.MAX_VALUE.toLong()) {
...
@kotlinx.serialization.Serializable
data class AgentLimitsDraft(val values: Map<AgentLimitField, String> = emptyMap()) {
...
@Composable
fun AgentLimitsSettingsSection(draft: AgentLimitsDraft, onChange: (AgentLimitsDraft) -> Unit) {
