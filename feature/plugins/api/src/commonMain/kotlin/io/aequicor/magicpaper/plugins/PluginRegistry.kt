...
interface CodingSessionPanel {
    ...
    @Composable
    fun SessionPanel(project: CodingProject, modifier: Modifier)
}
...
/** Optional application-owned draft lifecycle; registry IDs and the renderer SPI stay stable. */
interface PersistentPlugin {
    suspend fun flushDrafts()
    suspend fun prepareForReset() = flushDrafts()
