...
object SessionToolCatalog {
    val definitions = listOf(
        ...
        val scoped = definition.copy(orchestration = definition.id.startsWith("session."))
        if (!scoped.mutating) scoped else scoped.copy(description = scoped.description +
