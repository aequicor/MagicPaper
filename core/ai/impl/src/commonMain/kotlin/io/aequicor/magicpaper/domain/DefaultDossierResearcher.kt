...
class DefaultDossierResearcher(
...
fun DossierResearcher(gateway: LlmGateway, searchEngine: SearchEngine, json: Json = Json { ignoreUnknownKeys = true }): DossierResearcher = DefaultDossierResearcher(gateway, searchEngine, json)
