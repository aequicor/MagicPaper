...
const val DEFAULT_PLANNING_RULES_VERSION = 2
...
val DEFAULT_PLANNING_RULES = """
    ...
    Зигота — исходная рабочая сессия организма. Дочерние сессии и инструменты оркестрации выдаются только режиму планирования; обычный и исследовательский режимы работают без них. Делегируй независимые задачи через этапы плана, когда это помогает; происхождение сессий не заменяет зависимости заданий. Передавай результаты ответственному родителю для разрешения противоречий.
