...
fun Plan.acceptsPeerContext(sessions: List<CodingSession>): Boolean =
...
fun Plan.sharesPeerWorkspace(other: Plan): Boolean {
...
fun Plan.currentPeerResults(): List<CoordinationRecord> = selectedMilestones.mapNotNull { stage ->
...
fun peerContextMessageId(source: Plan, target: Plan, stageId: String): String =
...
fun Plan.cancelLegacyPeerCommands(peers: List<Plan>, admittedAttempts: Map<String, SessionLegacyAttempt> = emptyMap()): Plan {
