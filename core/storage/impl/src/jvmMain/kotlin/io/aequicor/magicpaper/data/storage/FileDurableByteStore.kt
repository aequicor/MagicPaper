...
fun desktopPersistenceStores(
    root: File = File(System.getProperty("user.home"), ".MagicPaper"),
    journalId: String = "main",
    fallbackJournalId: String? = null,
): PersistenceStores {
    val backend = FileDurableByteStore(File(root, "persistence"))
    return persistenceStores(backend, journalId, fallbackJournalId = fallbackJournalId)
}
