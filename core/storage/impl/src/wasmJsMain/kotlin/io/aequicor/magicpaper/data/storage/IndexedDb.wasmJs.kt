...
@JsFun("""(database, store, key, operation, value, callback) => {
    let finished = false;
...
private external fun performIndexedDb(database: String, store: String, key: String, operation: String, value: String?, callback: (String?, String?) -> Unit)
