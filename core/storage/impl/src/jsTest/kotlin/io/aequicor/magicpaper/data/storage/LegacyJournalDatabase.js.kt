...
private fun seedLegacyDatabase(database: String, version: Int, callback: (String?) -> Unit) {
    val bridge = js("""(database, version, callback) => {
    ...
    bridge(database, version, callback)
}
