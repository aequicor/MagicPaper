...
| Чат, отправка, composer | [chat](../../feature/chat) | `api/.../ui/ChatComponent.kt`, `ChatService.kt`; `impl/.../ui/DefaultChatService.kt`, `DefaultChatComponent.kt` | `:feature:chat:impl:jvmTest`; host integration: `:app:jvmTest --tests '*ChatServiceLifecycleTest'` |
| Кодинг, сессия, checkpoint | [coding](../../feature/coding) | `api/.../ui/CodingService.kt`; `impl/.../ui/DefaultCodingService.kt`, `DefaultCodingComponent.kt` | `:feature:coding:impl:jvmTest`; resume integration: `:app:jvmTest --tests '*CodingResumeTest'` |
...
| Макет по запросу обычного чата | [chat](../../feature/chat), [paper-editor](../../tools/paper-editor) | `LayoutEditor`, `LayoutChatAgent`, `DesktopLayoutEditor`, `DefaultChatService`; launcher `Main`, `PaperAgentCommands` | `:feature:chat:impl:jvmTest`; `:app:jvmTest --tests '*ChatLayoutWorkflowTest'`; [native-проверка](VERIFICATION.md) |
...
```sh
rg --files feature/chat -g '*.kt' -g '!**/build/**'
rg -n 'sendMessage|composerDraft' feature/chat/impl/src feature/chat/api/src
```
