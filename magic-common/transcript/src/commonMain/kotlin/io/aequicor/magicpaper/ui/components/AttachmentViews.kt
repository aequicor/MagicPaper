...
class AttachmentThumbnailRequestGate {
...
fun thumbnailKeyCanBeCached(key: AttachmentThumbnailKey): Boolean =
...
fun decodeAttachmentThumbnail(attachment: Attachment): ImageBitmap? = runCatching {
...
fun decodeAttachmentPreview(attachment: Attachment): ImageBitmap? = runCatching {
