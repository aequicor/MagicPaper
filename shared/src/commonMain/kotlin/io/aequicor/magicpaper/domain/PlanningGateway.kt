...
Задавай уточняющие вопросы, когда считаешь необходимым; обязательного первого раунда нет. При достаточных данных сразу подготовь план.
...
Соблюдай формат ответа, заданный в запросе. Промежуточные сообщения делай понятными пользователю, окончательный структурированный ответ возвращай только после исследования.
"""
