...
fun textPlanComposer(gateway: LlmGateway, json: Json = Json { ignoreUnknownKeys = true }, searchEngine: SearchEngine? = null) =
    ...
    }, projectLookup = { CodingProject(it, it, "/fixture", 0) })
