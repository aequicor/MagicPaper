        ...
        try {
            for (width in listOf(1000, 360)) {
                ...
                val service = OrchestrationService(store, execution, projects, profiles, settings,
                    ...
                    workerDispatcher = StandardTestDispatcher(testScheduler), modelDossiers = io.aequicor.magicpaper.domain.testModelDossiers()).also { executionPorts.chatHooks = it }
                ...
                checkpoints.save(project); checkpoints.saveSession(parent); profiles.save(profile)
