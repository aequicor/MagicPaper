...
import io.aequicor.magicpaper.designsystem.PaperResizablePanels
...
class PlanningChatRenderTest {
    ...
    @Test fun sidebarWidthChangesByDraggingDivider() = runTest {
        ...
        try {
            ...
            ImageComposeScene(1000, 620) {
                MagicPaperTheme { Surface { PaperResizablePanels(sidebar = { modifier ->
    ...
    @Test fun questionsAndGraphRenderInsideChatAtBothWidths() = runTest {
        ...
        try {
            ...
            val repo = journalCodingProjects(kv, Json)
            ...
            val execution = PlanningExecutionService(store, NoopCodingRuntime, repo, profiles, settings, verifier, workspaces = LocalPlanningWorkspace(), scope = backgroundScope,
