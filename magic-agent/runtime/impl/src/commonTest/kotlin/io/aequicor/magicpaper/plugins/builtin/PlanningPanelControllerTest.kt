...
class PlanningPanelControllerTest {
    private class Fixture(scope: CoroutineScope) {
        ...
        val execution = PlanningExecutionService(store, NoopCodingRuntime, projects, profiles, settings,
            ...
            }, workspaces = LocalPlanningWorkspace(), scope = scope,
        ...
        val controller = PlanningPanelController(store, textPlanComposer(gateway, retryLimit = 0), execution,
            ...
            }, profiles, settings, scope, modelDossiers = io.aequicor.magicpaper.domain.testModelDossiers())
        ...
        suspend fun seed() {
            projects.createTestProject(CodingProject(plan.projectId, "Project", "/fixture", 1))
