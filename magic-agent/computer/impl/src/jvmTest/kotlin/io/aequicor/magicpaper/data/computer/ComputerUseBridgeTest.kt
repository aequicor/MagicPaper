...
class ComputerUseBridgeTest {
    ...
    @Test fun duplicateRpcCannotRepeatInputAndCloseRevokesAccess(): Unit = runBlocking {
        ...
        val bridge = computer.testBridge("a")!!
        bridge.use {
    ...
    @Test fun codexConfigurationPreservesSandboxAndReplacesOldEndpoint(): Unit = runBlocking {
        ...
        computer.testBridge("a")!!.use { bridge ->
            val enabled = io.aequicor.magicpaper.domain.computerCodexConfig(base, bridge.descriptor)
            ...
            val disabled = io.aequicor.magicpaper.domain.computerCodexConfig(enabled, null)["mcp_servers.magicpaper_computer"]!!.jsonObject
