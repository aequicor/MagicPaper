...
val testCommandChecks = object : io.aequicor.magicpaper.domain.checks.CommandChecks {
    ...
    override suspend fun awaitConflictingChecks(command: io.aequicor.magicpaper.domain.checks.CheckCommand): Boolean = error("Unexpected command wait")
    override suspend fun awaitActive(ref: io.aequicor.magicpaper.domain.checks.CheckRef) = error("Unexpected command wait")
